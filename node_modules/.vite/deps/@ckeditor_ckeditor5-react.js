      ...
      _restoreCollaborationData() {
        ...
        if (this.editor.plugins.has("CommentsRepository")) {
          ...
          parsedCommentThreads.forEach((commentThreadData) => {
            ...
            commentsRepository2.addCommentThread({ channelId, ...commentThreadData });
          });
        }
...
// node_modules/@ckeditor/ckeditor5-watchdog/src/actionsrecorder.js
function tapObjectMethod(object, methodName, tap, context = {}) {
  ...
  object[methodName] = (...args) => {
    ...
    try {
      ...
      if (shouldHandle) {
        (_c = tap.error) == null ? void 0 : _c.call(tap, callContext, error);
      }
      throw error;
    }
  };
...
function serializeValue(value, visited = /* @__PURE__ */ new WeakSet()) {
  ...
  if (typeof value.toJSON == "function") {
    ...
    if (isPlainObject2(jsonData) || Array.isArray(jsonData) || ["string", "number", "boolean"].includes(typeof jsonData)) {
...
var ActionsRecorder;
var init_actionsrecorder = __esm({
  "node_modules/@ckeditor/ckeditor5-watchdog/src/actionsrecorder.js"() {
    init_compat2();
    ActionsRecorder = class {
      /**
       * @inheritDoc
       */
      constructor(editor) {
       ...
       */
      _leaveFrame(callFrame, result2, error) {
